...
export const Landing: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#131313] text-white">
      ...
      <header className="sticky top-0 z-50 bg-[#131313]/95 backdrop-blur-md border-b border-white/10">
        <div className="container mx-auto px-3 sm:px-6 py-2.5 sm:py-4 flex justify-between items-center">
      ...
      <section className="pt-16 sm:pt-20 md:pt-24 pb-10 sm:pb-16 px-3 sm:px-4">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="relative px-1 sm:px-2">
            <div className="bg-[#1a1a1a] border border-white/10 rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-5 md:p-8 shadow-2xl">
              ...
              <div className="bg-[#131313] rounded-md sm:rounded-lg p-3 sm:p-5 text-left">
                <p className="text-gray-400 text-[10px] sm:text-xs mb-1.5 sm:mb-2">Your public link:</p>
                <p className="text-white font-mono text-[11px] sm:text-xs md:text-sm break-all">
                  incognito.app/u/your-unique-id
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-10 sm:py-14 px-3 sm:px-4 bg-[#1a1a1a]/50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
            {/* Feature 1 */}
            <div className="bg-[#1a1a1a] border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-5 hover:border-white/20 transition-all">
            ...
            {/* Feature 3 */}
            <div className="bg-[#1a1a1a] border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-5 hover:border-white/20 transition-all sm:col-span-2 lg:col-span-1">
      ...
      <section className="py-10 sm:py-14 px-3 sm:px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-5">
            <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-5">
            ...
            <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-5">
            ...
            <div className="bg-gradient-to-br from-green-500/10 to-emerald-500/10 border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-5">
            ...
            <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-white/10 rounded-lg sm:rounded-xl p-4 sm:p-5">
      ...
      {/* CTA Section */}
      <section className="py-10 sm:py-14 px-3 sm:px-4 bg-gradient-to-r from-purple-600/20 to-pink-600/20">
        <div className="container mx-auto max-w-4xl text-center">
          <h3 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-5 px-2">
            Ready to Start Receiving Messages?
          </h3>
          <p className="text-sm sm:text-base text-gray-300 mb-5 sm:mb-7 px-3 sm:px-4">
            Create your free inbox and get your unique link in seconds.
          </p>
          <Button
            variant="primary"
            size="lg"
            onClick={() => navigate('/signup')}
            className="w-full sm:w-auto mx-3 sm:mx-0"
          >
            Get Started Free
          </Button>
        </div>
      ...
      {/* Footer */}
      <footer className="py-5 sm:py-7 px-3 sm:px-4 border-t border-white/10">
        <div className="container mx-auto text-center text-gray-400 text-[10px] sm:text-xs">
